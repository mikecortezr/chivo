...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Block\Slider\RecentProducts implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getCustomAddToCartUrl($product, $additional = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomAddToCartUrl');
        if (!$pluginInfo) {
            return parent::getCustomAddToCartUrl($product, $additional);
        } else {
            return $this->___callPlugins('getCustomAddToCartUrl', func_get_args(), $pluginInfo);
        }
    }
